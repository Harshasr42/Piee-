  ...
  return (
    <div className="flex flex-col items-center justify-between h-full w-full max-w-sm py-12 px-4 relative">
      ...
      <motion.div 
        ...
        className="mb-2 bg-rose-500/10 backdrop-blur-sm px-4 py-1.5 rounded-full border border-rose-200"
      >
        <p className="text-rose-500 font-bold uppercase tracking-widest text-[10px]">
          Memory <span className="text-rose-600">{index + 1}</span> of <span className="text-rose-600">{filteredMemories.length}</span>
        </p>
      </motion.div>
