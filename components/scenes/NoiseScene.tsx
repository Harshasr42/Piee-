  ...
  const handleClear = (id: string) => {
    setClearedIds(prev => {
      ...
      if (next.size === CLOUD_WORRIES.length) {
        // Show the special success message
        setShowSuccess(true);
        // Wait for a few seconds to let her read the message before proceeding
        ...
        {!showSuccess ? (
          ...
          >
            <div className="text-center z-20 space-y-4 mb-20">
              ...
              <p className="text-rose-300/80 font-medium uppercase tracking-widest text-[10px]">Let's clear some space for joy, Shreyaa.</p>
            </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <motion.p 
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="text-4xl font-serif text-rose-500 italic mt-4"
              >
                mrng mrng sunshine ✨
              </motion.p>
            </div>
            ...
            <motion.div 
              ...
              className="w-32 h-1 bg-rose-200 rounded-full origin-left"
            />
          </motion.div>
        )}
      </AnimatePresence>
